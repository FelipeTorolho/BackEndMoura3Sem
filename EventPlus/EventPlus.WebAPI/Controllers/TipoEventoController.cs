...
public class TipoEventoController : ControllerBase
{
    ...
    /// <summary>
    /// Endpoint da API que faz chamadas para o método de lista os tipos de eventos
    /// </summary>
    ...
    /// <summary>
    /// Endpoint da API que faz chamadas para o método de buscar um tipo de evento especifico
    /// </summary>
    ...
    /// <summary>
    /// Endpoint da API que faz a chamada para o metodo atualizar um tipo de evento 
    /// </summary>
    /// <param name="id">Id o tipo de evento a ser atualizado</param>
    /// <param name="tipoEvento">Tipo de evento atualizado</param>
